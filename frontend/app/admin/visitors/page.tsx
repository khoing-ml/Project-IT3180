      ...
      <div className="ml-72 p-8">
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="flex justify-between items-center mb-8">
            <div>
              <h1 className="text-4xl font-bold text-gray-900 mb-2">Quản Lý Khách Thăm</h1>
              <p className="text-gray-600">Phê duyệt và quản lý khách ghé thăm cư dân</p>
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-6 gap-4 mb-8">
            ...
            <div className="bg-white rounded-xl shadow-lg p-6 border-l-4 border-purple-500">
              <div className="flex items-center justify-between">
                <div>
                  <p className="text-sm text-gray-600 mb-1">Đến hôm nay</p>
                  <p className="text-3xl font-bold text-purple-600">{stats.todayExpected}</p>
                </div>
                    ...
                    {filteredVisitors.map((visitor) => (
                      <tr key={visitor.id} className="hover:bg-gray-50 transition-colors">
                        ...
                        <td className="px-6 py-4">
                          ...
                          <div className="text-sm text-gray-500">Căn hộ #{visitor.resident?.apartment_number}</div>
                        </td>
                ...
                <div className="p-8">
                  ...
                  <div className="grid grid-cols-2 gap-6 mb-6">
                    ...
                    <div className="col-span-2">
                      ...
                      <p className="text-gray-900">{selectedVisitor.resident?.full_name} (Căn hộ #{selectedVisitor.resident?.apartment_number})</p>
                      {selectedVisitor.resident?.email && (
                        <p className="text-sm text-gray-500">Email: {selectedVisitor.resident.email}</p>
                      )}
                    </div>
                  ...
                  {selectedVisitor.status === 'pending' && (
                    <div className="mb-6">
                      <label className="block text-sm font-medium text-gray-700 mb-2">Ghi Chú Phê Duyệt (Tùy chọn)</label>
                      <textarea
                        value={actionNotes}
